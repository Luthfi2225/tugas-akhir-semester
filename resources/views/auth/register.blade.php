<form method="POST" action="{{ route('register') }}">
    ...
    <div>
        ...
        <x-text-input id="name" class="block w-full dark:bg-[#3a3a3a] dark:border-black"
                        type="text"
                        name="name"
                        :value="old('name')"
                        required
    ...
    <div class="flex items-center justify-end mt-4">
        <button type="button" @click="page = 'login'" class="underline text-sm text-gray-600 dark:text-[#EDEDEC] hover:text-gray-900 dark:hover:text-gray-400 rounded-md">{{ __('Already registered?') }}</button>
